...
void CScene::AnimateObjects(float fTimeElapsed)
{
	...
	case SCENE_1:
		...
		CCollsionMgr::GetInstance()->CheckCollsion(m_pPlayer, m_pStandardObjectShader->GetObjectList(L"CactiBullet"), 0.5f);
		CCollsionMgr::GetInstance()->CheckCollsion(m_pDuoPlayer, m_pStandardObjectShader->GetObjectList(L"CactiBullet"), 0.5f);
